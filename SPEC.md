...
- **[SPEC.webapp.md](./SPEC.webapp.md)** - Web applications (layouts, pages, modals, routing)
- **[SPEC.mobile.md](./SPEC.mobile.md)** - Mobile applications (screens, tabs, sheets, swipe actions)
- **[SPEC.desktop.md](./SPEC.desktop.md)** - Desktop applications (windows, menus, toolbars, context menus)
