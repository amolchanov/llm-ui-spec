...
- **[SPEC.webapp.md](./SPEC.webapp.md)** - Web applications (pages, modals, routing)
- **[SPEC.mobile.md](./SPEC.mobile.md)** - Mobile applications (screens, sheets, gestures)
- **[SPEC.desktop.md](./SPEC.desktop.md)** - Desktop applications (windows, menus, toolbars)
